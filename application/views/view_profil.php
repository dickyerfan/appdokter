                ...
                <div class="col-lg-6">
                    <div class="card shadow my-5 border-0">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Nama : <?= $this->session->userdata('fullname'); ?></h5>
                        ...
                        <div class="card-footer">
                            <a href="<?= ($this->session->userdata('level') == 'Dokter') ? base_url('dokter') : base_url('dashboard') ?>" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
